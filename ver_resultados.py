...
importlib.reload(p)
a, b, fig, axs = p.comparar_red_kmeans(
...
importlib.reload(p)
centroides_k, centroides_red, fig, axs = p.comparar_red_kmeans(
...
# Create thaxs[2]e animation

# Create the animation
ani = FuncAnimation(fig, update, frames=np.arange(0, 360, 1), interval=500, blit=False)

# Save the animation as an MP4
writer = FFMpegWriter(fps=80, metadata=dict(artist="Me"), bitrate=10000)
ani.save("3d_rotation.mp4", writer=writer)
